          ...
          <div class="clearfix"></div>
              ...
              <!-- /menu profile quick info -->
                  <ul class="nav side-menu">
                    <li><a href="panelAdmin.php"><i class="fa fa-home"></i> Anasayfa</a>
                    </li>
                    <li><a href="personelEkle.php"><i class="fa fa-edit"></i>Personel Ekle </a>
                    </li>
                    <li><a href="personelList.php"><i class="fa fa-table"></i> Personel Listesi</a>
                    </li>

                    <li><a href="musteriList.php"><i class="fa fa-table"></i> Müşteri Listesi</a>
                    </li>
    ...
    <div class="container body">
        <div class="main_container">
          ...
          <div class="clearfix"></div>
              ...
              <!-- /menu profile quick info -->
                  <ul class="nav side-menu">
                    <li><a href="panelPersonel.php"><i class="fa fa-home"></i> Anasayfa</a>
                    </li>
                    <li><a><i class="fa fa-edit"></i> Satış Paneli </a>
                    </li>
                    <li><a href="musteriList.php"><i class="fa fa-table"></i> Personel Listesi</a>
                    </li>
                  </ul>
                </div>
