              ...
              <div class="x_panel">
                <div class="x_content">
                  ...
                  <!-- Ana Ürün Resmi Başlangıç-->
                    <div>
                      <img src="images/urun68_1.jpg" width="390px" height="390" alt="..." />
                    </div>
                  <!-- Ana Ürün Resmi Bitiş -->

                    <div class="product_gallery">
                      <a>
                        <img src="images/urun68_2.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="images/urun68_3.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="images/urun68_4.jpg" alt="..." />
                      </a>
                    </div>
                  </div>
...
<!-- Parça Adı Başlangıç -->
  <h3 class="prod_title"> GIGABYTE 240GB SATA 3.0 2.5 SSD (500MB Okuma/420MB Yazma) </h3>
<!-- Parça Adı Bitiş -->
<br /><br />
...
<!-- Temel Bilgiler Başlangıç -->
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"> 
          ...
          GIGABYTE 240GB SATA 3.0 2.5" SSD (500MB Okuma/420MB Yazma )
</br>
Yeni güncellenen SSD Tool Box, kullanıcıların SSD Durumunu izlemelerine yardımcı olan, model adı, FW sürümü, sağlık durumu, sürücü optimizasyonu gibi genel bilgiler sağlayan ve ayrıca sensör sıcaklığını algılayan bir uygulamadır. Ayrıca, kullanıcılar Güvenli Silme işlevi ile tüm verileri temizleyebilir. SSD Araç Kutusunu Destek bölümünden indirebilirsiniz.
</br>
</br>
Güvenebileceğiniz Güvence - 3 Yıllık Sınırlı Garanti
</br>
GIGABYTE SSD-ler, yüksek veri aktarma hızına ve gelişmiş dayanıklılığa sahip olup, dayanıklı MTBF * 2.0 milyon saat ve 3 yıl veya 100 TBW sınırlı garanti sağlar.
</div>
