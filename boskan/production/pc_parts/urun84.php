              ...
              <div class="x_panel">
                <div class="x_content">
                  ...
                  <!-- Ana Ürün Resmi Başlangıç-->
                    <div>
                      <img src="images/urun84_1.jpg" width="390px" height="390" alt="..." />
                    </div>
                  <!-- Ana Ürün Resmi Bitiş -->

                    <div class="product_gallery">
                      <a>
                        <img src="images/urun84_2.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="images/urun84_3.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="images/urun84_4.jpg" alt="..." />
                      </a>
                    </div>
                  </div>
...
<!-- Parça Adı Başlangıç -->
  <h3 class="prod_title">Thermaltake Water 3.0 240 ARGB Sync Edition All-In-One Sıvı Soğutma Sistemi (CL-W233-PL12SW-A)</h3>
<!-- Parça Adı Bitiş -->
<br /><br />
...
<!-- Temel Bilgiler Başlangıç -->
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"> 
          ...
          Thermaltake Water 3.0 240 ARGB Sync Edition All-In-One Sıvı Soğutma Sistemi (CL-W233-PL12SW-A) Özellikleri
</div>
