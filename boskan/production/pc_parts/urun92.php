              ...
              <div class="x_panel">
                <div class="x_content">
                  ...
                  <!-- Ana Ürün Resmi Başlangıç-->
                    <div>
                      <img src="images/urun92_1.jpg" width="390px" height="390" alt="..." />
                    </div>
                  <!-- Ana Ürün Resmi Bitiş -->

                    <div class="product_gallery">
                      <a>
                        <img src="images/urun92_2.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="images/urun92_3.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="images/urun92_4.jpg" alt="..." />
                      </a>
                    </div>
                  </div>
...
<!-- Parça Adı Başlangıç -->
  <h3 class="prod_title">Cooler Master MasterAir MA612 Stealth 120mm ARGB İşlemci Hava Soğutucu</h3>
<!-- Parça Adı Bitiş -->
<br /><br />
...
<!-- Temel Bilgiler Başlangıç -->
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"> 
          ...
          Nikel Kaplama Bakır Taban
</br>
Nikel kaplı bakır taban, maksimum soğutma performansı için mükemmel bir performans sağlar.
</br>
</br>
%100 RAM Uyumluluğu
</br>
Asimetrik 6 ısı borusu, çeşitli anakartlar ve RAM modellerinde uyumluluk içinde yeterli açıklık sağlar.
        </div>
