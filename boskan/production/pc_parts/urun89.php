              ...
              <div class="x_panel">
                <div class="x_content">
                  ...
                  <!-- Ana Ürün Resmi Başlangıç-->
                    <div>
                      <img src="images/urun89_1.jpg" width="390px" height="390" alt="..." />
                    </div>
                  <!-- Ana Ürün Resmi Bitiş -->

                    <div class="product_gallery">
                      <a>
                        <img src="images/urun89_2.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="images/urun89_3.jpg" alt="..." />
                      </a>
                      <a>
...
<!-- Parça Adı Başlangıç -->
  <h3 class="prod_title">ASUS ROG Strix Lc Ii 240 ARGB White Edition Aura Sync Rgb Sivi Cpu Soğutucusu </h3>
<!-- Parça Adı Bitiş -->
<br /><br />
...
<!-- Temel Bilgiler Başlangıç -->
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"> 
          ...
          ASUS ROG Strix Lc Ii 240 ARGB White Edition Aura Sync Rgb Sivi Cpu Soğutucusu        
        </div>
