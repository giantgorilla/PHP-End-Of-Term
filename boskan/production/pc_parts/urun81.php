              ...
              <div class="x_panel">
                <div class="x_content">
                  ...
                  <!-- Ana Ürün Resmi Başlangıç-->
                    <div>
                      <img src="images/urun81_1.jpg" width="390px" height="390" alt="..." />
                    </div>
                  <!-- Ana Ürün Resmi Bitiş -->

                    <div class="product_gallery">
                      <a>
                        <img src="images/urun81_2.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="images/urun81_3.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="images/urun81_4.jpg" alt="..." />
                      </a>
                    </div>
                  </div>
...
<!-- Parça Adı Başlangıç -->
  <h3 class="prod_title">Thermaltake TH360 ARGB Led Fanlı 360mm İntel/AM4 Serisi Uyumlu Sıvı Soğutma Sistemi (CL-W300-PL12SW-A)</h3>
<!-- Parça Adı Bitiş -->
<br /><br />
...
<!-- Temel Bilgiler Başlangıç -->
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"> 
          ...
          Thermaltake TH360 ARGB Led Fanlı 360mm İntel/AM4 Serisi Uyumlu Sıvı Soğutma Sistemi (CL-W300-PL12SW-A) Özellikleri
</div>
