...
//echo "Personel Başarıyla Eklendi. Yönlendiriliyorsunuz..";
header("Refresh: 2; url=personelEkle.php");
ob_end_flush();
?>
...
<html>
  ...
  <body style="background-color: #f2f2f2;">
    <div class="card" style="margin-top: 10%; margin-left: 25%; width: 50%; box-shadow: 0px 0px 110px -25px rgba(0,0,0, 0.5);">
      <div class="card-body">
        <p class="card-text">Personel Başarıyla Eklendi. Yönlendiriliyorsunuz..</p>
        <div class="progress">
